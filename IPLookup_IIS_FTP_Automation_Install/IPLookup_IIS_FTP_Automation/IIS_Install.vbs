...
Function Execute()
	...
	Else
		...
		objShell.Run "Log.vbs NOTIFICATION CRITICAL_FTP_SERVICE_IS_ALREADY_RUNNING",0,true
		objShell.Run "Log.vbs PROGRESS CRITICAL_FTP_SERVICE_IS_ALREADY_RUNNING",0,true
